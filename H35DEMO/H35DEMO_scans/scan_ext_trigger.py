...
class ExtTriggerScan(Fei4RunBase):
    ...
    For use with external scintillator (user RX0), TLU (use RJ45), FE-I4 HitOR (USBpix self-triggeer).
    ...
    def start_readout(self, **kwargs):
        ...
        self.fifo_readout.start(reset_sram_fifo=True, clear_buffer=True, callback=self.handle_data, errback=self.handle_err, no_data_timeout=self.no_data_timeout)
