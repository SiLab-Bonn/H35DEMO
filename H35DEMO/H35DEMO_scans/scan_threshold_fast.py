...
class FastThresholdScan(Fei4RunBase):
    ...
    def init_dut(self):
            ...
            self.dut['CCPD_vddaPRE'].set_voltage(1.5, unit='V')
            self.dut['CCPD_vddaPRE'].set_enable(True)
            
            self.dut['CCPD_vddd'].set_voltage(1.8, unit='V')
            self.dut['CCPD_vddd'].set_enable(True)

            self.dut['CCPD_VCasc'].set_voltage(1.0, unit='V')        
            self.dut['CCPD_BL'].set_voltage(0.75, unit='V')
            self.dut['CCPD_TH'].set_voltage(1.5, unit='V')
            self.dut['CCPD_ADCref'].set_voltage(0.7, unit='V')
            ...
            self.dut['probePBIAS'].set_current(0,unit="uA")
            ...
            #self.logger.info("Vdda:1.8 Vddp:1.5 Vddd:1.8 VCasc:1.0 BL:0.75 TH:1.5 PCBTH:%f ADCref:%f"%(
